$(document).ready(function() {
    ...
    // ajax request to load more games from the server
    // by incrementing the page number, and making a GET request
    ...
    // function to create a game div, with all the necessary information
    // for a game, such as title, images, creator, and vote count, and voting status
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex gap-2">
                            <div class="vote-container">
                                <button type="button" class="btn btn-sm vote-button upvote-button ${upvoteClass}" data-fetch-url="/api/upvote/${game.gameId}">
                                ...
                                <button type="button" class="btn btn-sm vote-button downvote-button ${downvoteClass}" data-fetch-url="/api/downvote/${game.gameId}">
    ...
    // debouncing mechanism to prevent multiple calls to loadMoreGames
    // while a timer is running, we don't want to call loadMoreGames
