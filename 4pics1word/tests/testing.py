...
#     def test_password_hash_salting(self):
#         # test hashing the same password produces different hashes (random password salting)
#         password = "MySecretPassword"
#         hashed_password_1 = self.bcrypt.generate_password_hash(password)
#         #print(hashed_password_1)
#         hashed_password_2 = self.bcrypt.generate_password_hash(password)
...
class TestWebApp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.options.binary_location = '/mnt/c/Program Files (x86)/Microsft/Edge/Application/msedge.exe'
        #service = Service(executable_path=os.path.join(basedir, 'chromedriver'))
    ...
    def test_login_valid_credentials(self):
        ...
        username_field = self.driver.find_element_by_id("username-login")
        password_field = self.driver.find_element_by_id("password-login")
